...
const Form = () => {
  ...
  const openWeatherApiKey = "898aa368a98ad30900754aebb87d9021";
      ...
      <div className="max-w-screen-sm w-full p-10 border border-gray-300 rounded-lg shadow-lg bg-white">
        ...
        {weather.name && (
          <>
            ...
            <h2 className="text-center border p-2 mx-4 bg-blue-300 rounded-full">
              {today}
            </h2>
            <div className="flex items-center justify-center mb-4">
              <div>
                <IoSunnySharp className="mr-5 text-2xl" />
              </div>
            ...
            <h1 className="text-9xl font-bold text-center mb-8">
              {weather.main?.temp ? weather.main.temp : "N/A"}°C
            </h1>
